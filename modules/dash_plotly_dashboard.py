    ...
    app.layout = html.Div(
        ...
        children=[
            ...
            html.H3(
                ...
                an individual, so I'm updating my container manually for now, and I think I'm going to configure soon a GCP Cloud 
                Scheduler cron job for the automatic rebooting.""",
                style={
                    "textAlign": "left",
                    "backgroundColor": "#1F2630",
                    "font-family": "Lato",
